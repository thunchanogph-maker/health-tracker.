            ...
            {selectedRecord ? (
              <div className="space-y-3">
                ...
                {selectedRecord.photo && (
                  <div className="mt-2 rounded-xl overflow-hidden border border-[#3D3759]">
              ...
              <div className="flex flex-col items-center py-6 text-center gap-2">
                ...
                <button
                  ...
                  className="mt-2 px-5 py-2 rounded-xl text-xs font-black text-slate-900 transition hover:scale-105 border cursor-pointer"
